...
# Preparar Logo da Equatorial
logo_eqtl_b64 = ""
if os.path.exists("LOGO_EQTL.png"):
    with open("LOGO_EQTL.png", "rb") as f:
        logo_eqtl_b64 = base64.b64encode(f.read()).decode()

logo_html = f'<img src="data:image/png;base64,{logo_eqtl_b64}" style="height: 35px; max-width: 150px; object-fit: contain;">' if logo_eqtl_b64 else '<div style="color: white; line-height: 1.1;"><span style="font-size: 7px;">GRUPO</span><br><span style="font-size: 16px; font-weight: bold;">equatorial</span><br><span style="font-size: 7px; font-weight: normal; letter-spacing: 1px;">ENERGIA</span></div>'
