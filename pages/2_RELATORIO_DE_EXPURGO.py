...
<style>
    ...
    /* Esconder os campos de input do topo e o menu lateral na hora da impressão */
    @media print {
...
if nota_val and not df_notas.empty:
    ...
    if not res.empty:
        ...
        # Puxa Parceiro da coluna NOME (conforme solicitado)
...
if foto_upload is not None:
    ...
    img_html = f'<img src="data:image/png;base64,{foto_base64}" style="max-height: 330px; max-width: 100%; object-fit: contain;">'
else:
    img_html = '<span style="color: #ccc; font-style: italic;">Clique no campo acima para anexar imagem</span>'
...
.header-box {{ background-color: #1b365d; color: white; display: flex; align-items: center; height: 50px; padding: 0 15px; border: 1px solid black; margin-bottom: 12px; -webkit-print-color-adjust: exact; print-color-adjust: exact; }}
.header-logo {{ font-weight: bold; font-size: 13px; border-right: 1px solid white; padding-right: 15px; margin-right: 15px; line-height: 1; }}
.header-title {{ font-size: 16px; margin: 0; text-align: center; flex-grow: 1; margin-left: -80px; font-weight: bold; }}
.section-title {{ background-color: #1b365d; color: white; font-weight: bold; padding: 3px 8px; border: 1px solid black; margin-bottom: 4px; font-size: 12px; -webkit-print-color-adjust: exact; print-color-adjust: exact; }}
.t-table {{ width: 100%; border-collapse: collapse; margin-bottom: 4px; }}
.t-table td {{ border: 1px solid black; padding: 3px 5px; vertical-align: middle; }}
.lbl {{ font-weight: bold; text-align: center; font-size: 11px; }}
.val {{ padding: 0 !important; }}
.fi {{ width: 100%; height: 100%; border: none; outline: none; background: transparent; font-family: Arial, sans-serif; font-size: 11px; font-weight: bold; color: black; padding: 4px; box-sizing: border-box; text-transform: uppercase; }}
.fa {{ width: 100%; border: none; outline: none; background: transparent; font-family: Arial, sans-serif; font-size: 11px; font-weight: bold; color: black; padding: 4px; box-sizing: border-box; resize: none; overflow: hidden; min-height: 35px; text-transform: uppercase; }}
...
<div id="area-impressao" class="form-container">
    ...
    <table class="t-table" style="margin-bottom: 12px;">
      <tr>
        ...
        <td class="lbl" style="width: 10%; font-size: 9px; line-height: 1.1;">Data da<br>abertura:</td>
    ...
    <table class="t-table">
      <tr>
        ...
        <td class="val" style="width: 85%;"><input type="text" class="fi" value=""></td>
      </tr>
    </table>
    <table class="t-table">
      <tr>
        <td class="lbl" style="width: 20%;">Descrição do Expurgo:</td>
        <td class="val" style="width: 80%;"><textarea class="fa"></textarea></td>
      </tr>
    </table>
    <table class="t-table" style="margin-bottom: 12px;">
      <tr>
        <td class="lbl bg-blue" style="width: 25%;">Tratativa no Sistema Comercial:</td>
        <td class="val bg-blue" style="width: 75%;"><input type="text" class="fi bg-blue" value=""></td>
      </tr>
    </table>
    ...
    <table class="t-table" style="margin-bottom: 10px;">
      <tr>
        <td class="lbl" style="width: 25%; text-align: left; font-size: 10px;">Número do medidor<br>do cliente atendido:</td>
        <td class="val" style="width: 20%;"><input type="text" class="fi" value="" style="text-align: center;"></td>
        <td class="no-border" style="width: 10%;"></td>
        <td class="lbl" style="width: 25%; text-align: left; font-size: 10px;">Número da nota do<br>atendimento em campo:</td>
        <td class="val" style="width: 20%;"><input type="text" class="fi" value="{nota_val}" style="text-align: center;"></td>
      </tr>
      <tr>
        <td class="lbl" style="width: 25%; text-align: left; font-size: 10px; border-top: none;">Número do medidor<br>do vizinho:</td>
        <td class="val" style="width: 20%; border-top: none;"><input type="text" class="fi" value="" style="text-align: center;"></td>
        <td class="no-border" style="width: 10%;"></td>
        <td class="lbl" style="width: 25%; text-align: left; font-size: 10px; border-top: none;">Número da estrutura<br>mais próxima:</td>
        <td class="val" style="width: 20%; border-top: none;"><input type="text" class="fi" value="" style="text-align: center;"></td>
      </tr>
    </table>

    <!-- FOTO -->
    <div style="border: 1px solid black; width: 100%; height: 350px; display: flex; align-items: center; justify-content: center; background-color: white; overflow: hidden;">
        {img_html}
    </div>
...
# Remover espaços e quebras que o Streamlit confunde com Markdown Code Blocks
